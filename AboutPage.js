...
const AboutPage = () => {
  return (
    <section className="bg-white dark:bg-gray-900">
      <div className="container mx-auto my-10 p-6 bg-gray-50 rounded-md shadow-md">
        ...
        <p className="text-lg mb-4">
          Our hotel features a wide range of amenities and services to ensure a
          comfortable and memorable stay for our guests. From elegant rooms and
          suites to fine dining restaurants and recreational facilities, we
          strive to exceed your expectations at every turn.
        </p>
        <p className="text-lg mb-4">
          At our hotel, we are committed to delivering personalized service and
          attention to detail. Whether you're here for business or leisure, our
          dedicated staff is here to assist you with any request and make your
          stay truly exceptional.
        </p>
        <p className="text-lg">
          Thank you for choosing our hotel for your accommodation needs. We look
          forward to welcoming you and providing you with an unforgettable
          experience.
        </p>
